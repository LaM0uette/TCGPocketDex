...
namespace TCGPocketDex.Api.Migrations
{
    ...
    [Migration("20260129190326_AddStadium")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entities.CardStadium", b =>
                {
                    b.Property<int>("CardId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entities.CardStadium", b =>
                {
                    b.HasOne("TCGPocketDex.Api.Entities.Card", "Card")
                        .WithOne("Stadium")
                        .HasForeignKey("TCGPocketDex.Api.Entities.CardStadium", "CardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

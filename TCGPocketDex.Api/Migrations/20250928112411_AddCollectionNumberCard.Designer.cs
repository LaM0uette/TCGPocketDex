...
namespace TCGPocketDex.Api.Migrations
{
    ...
    [Migration("20250928112411_AddCollectionNumberCard")]
    partial class AddCollectionNumberCard
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.Booster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.BoosterTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.CardExtension", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.CardExtensionTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.PokemonStage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.PokemonStageTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.PokemonWeakness", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.PromoSeries", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.PromoSeriesTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.FossilCard", b =>
                {
                    b.HasBaseType("TCGPocketDex.Api.Entity.Card");
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.ItemCard", b =>
                {
                    b.HasBaseType("TCGPocketDex.Api.Entity.Card");
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.PokemonCard", b =>
                {
                    b.HasBaseType("TCGPocketDex.Api.Entity.Card");
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.PokemonToolCard", b =>
                {
                    b.HasBaseType("TCGPocketDex.Api.Entity.Card");
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.SupporterCard", b =>
                {
                    b.HasBaseType("TCGPocketDex.Api.Entity.Card");
            ...
            modelBuilder.Entity("PokemonAttackPokemonCard", b =>
                {
                    ...
                    b.HasOne("TCGPocketDex.Api.Entity.PokemonCard", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.Booster", b =>
                {
                    b.HasOne("TCGPocketDex.Api.Entity.CardExtension", "CardExtension")
                        .WithMany()
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.BoosterTranslation", b =>
                {
                    b.HasOne("TCGPocketDex.Api.Entity.Booster", "Booster")
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.Card", b =>
                {
                    ...
                    b.HasOne("TCGPocketDex.Api.Entity.CardExtension", "Extension")
                        .WithMany("Cards")
                        .HasForeignKey("CardExtensionId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.HasOne("TCGPocketDex.Api.Entity.PromoSeries", "PromoSeries")
                        .WithMany("Cards")
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.PokemonStageTranslation", b =>
                {
                    b.HasOne("TCGPocketDex.Api.Entity.PokemonStage", "PokemonStage")
                        .WithMany("Translations")
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.PokemonWeakness", b =>
                {
                    b.HasOne("TCGPocketDex.Api.Entity.PokemonCard", "Pokemon")
                        .WithOne("Weakness")
                        .HasForeignKey("TCGPocketDex.Api.Entity.PokemonWeakness", "PokemonCardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.FossilCard", b =>
                {
                    b.HasOne("TCGPocketDex.Api.Entity.Card", null)
                        .WithOne()
                        .HasForeignKey("TCGPocketDex.Api.Entity.FossilCard", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.ItemCard", b =>
                {
                    b.HasOne("TCGPocketDex.Api.Entity.Card", null)
                        .WithOne()
                        .HasForeignKey("TCGPocketDex.Api.Entity.ItemCard", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.PokemonCard", b =>
                {
                    b.HasOne("TCGPocketDex.Api.Entity.Card", null)
                        .WithOne()
                        .HasForeignKey("TCGPocketDex.Api.Entity.PokemonCard", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("TCGPocketDex.Api.Entity.PokemonStage", "Stage")
                        .WithMany()
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.PokemonToolCard", b =>
                {
                    b.HasOne("TCGPocketDex.Api.Entity.Card", null)
                        .WithOne()
                        .HasForeignKey("TCGPocketDex.Api.Entity.PokemonToolCard", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("TCGPocketDex.Api.Entity.SupporterCard", b =>
                {
                    b.HasOne("TCGPocketDex.Api.Entity.Card", null)
                        .WithOne()
                        .HasForeignKey("TCGPocketDex.Api.Entity.SupporterCard", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
